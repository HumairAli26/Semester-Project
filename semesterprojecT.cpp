...
public:
    ...
    void candidateMenu(candidate& currentCandidate) {
        int choice;
        do {
            cout << "\nCandidate Menu:\n";
            ...
            switch (choice) {
            case 1:
                currentCandidate.displaydetails();
                break;
            case 2:
                cout << "Current Vote Count: " << currentCandidate.getvotecount() << endl;
                break;
            case 3: {
                string targetArea;
                ...
                while (getline(fin, name)) {
                    ...
                    if (area == targetArea) {
                        found = true;
                        cout << name << " (" << party << ") - Symbol: " << symbol << " - Votes: " << votes << endl;
                    }
                }
...
public:
    ...
    void createElection() 
    {
        ...
        if (!file.is_open()) 
        {
            cout << Red << "Error: Could not open election.txt file.\n" << Reset;
            return;
        }
        ...
        switch (electionType) 
        {
            case 1:
                ...
                file << "Election Number: " << ++electionCount << "\n";
                file << "----------------------\n\n";
                break;
            case 2:
