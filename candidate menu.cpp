...
public:
    ...
    (string n, int a, string c, string cn, string r, string p, string es, string cID)
        : user(n, a, c, cn, r, p), CandidateID(cID), electsymbol(es) {};

    void candidateMenu() {//candidate menu 
        int choice;
        do {
           
            cout << "=========================================\n";
            cout << "        CANDIDATE DASHBOARD\n";
            cout << "=========================================\n";
            cout << "1. View My Information\n";
            cout << "2. View My Vote Count\n";
